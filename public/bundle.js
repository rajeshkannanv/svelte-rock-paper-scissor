...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	var div2, div0, h1, t1, div1, span, t3, p, t4_value = ctx.score || '-' + "", t4;
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t = space();
    			attr_dev(img, "src", img_src_value = "./img/icon-" + ctx.name + ".svg");
    		...
    		p: function update(changed, new_ctx) {
    			ctx = new_ctx;
    			if ((changed.selectors) && img_src_value !== (img_src_value = "./img/icon-" + ctx.name + ".svg")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(56:2) {#each selectors as name}", ctx });
    	return block;
    }
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { onclick, selectors = [], visible } = $$props;
    	...
    	const click_handler = ({ name }) => onclick(name);
    	...
    	$$self.$capture_state = () => {
    		return { onclick, selectors, visible };
    	};
    ...
    class Selectors extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Selectors", options, id: create_fragment$1.name });
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(122:2) {#if resultMessage}", ctx });
    	return block;
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "src", img0_src_value = "./img/icon-" + ctx.userPicked + ".svg");
    			...
    			attr_dev(img1, "src", img1_src_value = "./img/icon-" + ctx.machinePicked + ".svg");
    		...
    		p: function update(changed, ctx) {
    			if ((changed.userPicked) && img0_src_value !== (img0_src_value = "./img/icon-" + ctx.userPicked + ".svg")) {
    			...
    			if ((changed.machinePicked) && img1_src_value !== (img1_src_value = "./img/icon-" + ctx.machinePicked + ".svg")) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { userPicked = "", machinePicked = "", resultMessage, onPlayagain, visible } = $$props;
    	...
    	$$self.$capture_state = () => {
    		return { userPicked, machinePicked, resultMessage, onPlayagain, visible };
    	};
    ...
    class Result extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Result", options, id: create_fragment$2.name });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "src", "./img/icon-close.svg");
    			...
    			attr_dev(img1, "src", "./img/image-rules.svg");
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(105:0) {#if isRuleOpen}", ctx });
    	return block;
    }
    ...
    function instance$3($$self, $$props, $$invalidate) {
      ...
      function onClose() {
    	...
    	return { isRuleOpen, onRuleOpen, onClose };
    }
    ...
    class Rules extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Rules", options, id: create_fragment$3.name });
    	}
    }
    ...
    function create_else_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block.name, type: "else", source: "(61:2) {:else}", ctx });
    	return block;
    }
    ...
    function create_if_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$2.name, type: "if", source: "(59:2) {#if userPicked}", ctx });
    	return block;
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	var rules_1 = new Rules({ $$inline: true });
